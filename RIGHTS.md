...
|---|---|---|---|
| `index.html`, contracts, and tests | Original project code | Static browser app, browser-local MWE review, and verification | Dual-licensed MIT or CC BY 4.0 at the recipient's choice; the two starter patterns are project-authored functional examples, not copied lexical-resource entries. No third-party runtime code. |
